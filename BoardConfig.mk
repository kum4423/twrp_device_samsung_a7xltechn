...
TARGET_BOOTLOADER_BOARD_NAME := MSM8939       # From ro.product.board
...
TARGET_BOARD_SUFFIX :=                        # Remove if the device is 32-bit
TARGET_USES_64_BIT_BINDER :=                  # Remove if the device is 32-bit
